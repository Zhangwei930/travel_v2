...
_NON_DEST_CATEGORIES = ("公司企业", "汽车", "金融", "保险", "医疗", "政府", "商务住宅")
# 餐饮类词：一般场景算噪声剔除，但「美食」场景下这些正是目的地 → allow_food 豁免
_NON_DEST_FOOD_TERMS = (
    "餐饮", "米铺", "米线", "面馆", "牛肉", "餐厅", "饭店", "餐馆", "小吃", "火锅",
    "烧烤", "串串", "烤肉", "快餐", "食府", "茶楼",
)
...
_NON_DEST_SERVICE_TERMS = (
    ...
    "酒吧", "艾灸", "香道", "按摩", "足浴", "养生馆", "养生会所", "SPA", "spa", "文化墙",
    "广告", "图文", "打印", "复印", "印刷", "文印", "快印", "标识", "喷绘",
    "厂", "制造", "加工", "产业园", "工业园", "仓储", "仓库", "物流",
    "集团", "实业", "贸易",
)
